...
class ResponseGenerator:
    ...
    def clarify(self, data_frame, ingredient=None, matched=None, repeated=None):
        ...
        if matched:
            feedback = ['Good job, ',
                        ...
                        'Good work, it was just luck '][random.randrange(5)]
        else:
    ...
    def eval(self, complete, matches):
        ...
        if evaluation == 100:
            ...
            answer = ['I would\'ve expected nothing more from you Potter, I can see you were raised by muggles.',
                      ...
                      'You are just as useless as your father Potter, you failed this exam.'][random.randrange(4)]
    ...
    def refusal(self):
        answer = ['Answers like this will cost some points to your House',
                  ...
                  'Mr Potter I remind you this is not Defence against the Dark Arts'][random.randrange(4)]
